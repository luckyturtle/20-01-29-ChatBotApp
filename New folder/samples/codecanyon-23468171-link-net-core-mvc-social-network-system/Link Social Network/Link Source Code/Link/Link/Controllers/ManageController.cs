...
namespace Link.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            var isCurrentNameIsExist = _userManager.Users.Where(u => u.UserName.Equals(model.Username) && u.Id != user.Id).Any();
            ...
            var isCurrentEmailIsExist = _userManager.Users.Where(u => u.Email.Equals(model.Email) & u.Id != user.Id).Any();
