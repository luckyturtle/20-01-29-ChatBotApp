    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = _userManager.Users.Where(u => u.Email.Equals(model.Email)).SingleOrDefault(); //changed by Link Developer
                if (user == null)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    _userLog.Add(UserAction.LogIn, user.Id);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Username, Email = model.Email, GenderId = model.GenderId, RegistrationDate = DateTime.Now };
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            _userLog.Add(UserAction.LogOut, _userManager.GetUserId(User));
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                _userLog.Add(UserAction.LogIn, _userManager.GetUserId(User));
